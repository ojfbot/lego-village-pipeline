...
**Status:** reference, as-built · **Describes the system at register `2026-09-18.17`** · **Author:** Claude (Cowork), correspondence steward · **Date:** 2026-09-18
...
| **Design package** (passes through) | A cut of the design session's whole `handoff/` tree — sheets, specs, ledgers, standalones | `H-01 R<n>` + zip sha256 | A row (the `HANDOFF-014` row records the cut it executed) and a version note on import | **Verbatim, never edited** under `docs/design/H-01-R<n>/`; its `decisions.md` is append-only and is the one file meant to grow | revision + DEC-ids inside it |
...
— Claude (Cowork), correspondence steward · register version read `2026-09-18.17` · decisions by James (`@ojfbot`)
