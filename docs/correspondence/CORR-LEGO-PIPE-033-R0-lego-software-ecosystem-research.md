...
register:
  number: 033
  allocated_by: "proposed — James confirms (032 is allocated and in flight on corr/032-register-migration-work-order)"
...
# CORR-LEGO-PIPE-033 R0 — The LEGO software ecosystem, read for play-well

**Status: for review.** A research intake. Nothing here authorizes work. Number 033
**proposed — James confirms.**
...
Timing note: 032 (register migration) is in flight and may move the version notes out of
this file. If it lands first, this memo's register delta moves with it and renumbers on
landing — ordinary procedure.
